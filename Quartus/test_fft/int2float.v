...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
module  int2float_altbarrel_shift_kuf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //int2float_altbarrel_shift_kuf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2float_altfp_convert_okn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	int2float_altbarrel_shift_kuf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //int2float_altfp_convert_okn
//VALID FILE
...
`endif
	...
	int2float_altfp_convert_okn	int2float_altfp_convert_okn_component (
				.dataa (dataa),
				.clk_en (clk_en),
				.clock (clock),
				.result (sub_wire0));
