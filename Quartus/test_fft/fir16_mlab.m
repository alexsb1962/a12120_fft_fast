...
%Input Data Width:	16
%Decimation Factor:   3
%LSB Truncated bits:%LSB Rounded bits  :16
%FIR Width (Full Calculation Width Before Output Width Adjust) :   32
%-----------------------------------------------------------------------------------------------------------

	%MegaWizard Scaled Coefficient Values
	function  output = fir16_mlab_mat (stimulation, output)
	coef_matrix=[-42 -10 56 172 292 339 250 18 -270 -460 -406 -69 422 799 777 232 -671 -1482 -1630 -691 1362 4076 6637 8190 8190 6637 4076 1362 -691 -1630 -1482 -671 232 777 799 422 -69 -406 -460 -270 18 250 339 292 172 56 -10 -42 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 3;
	MSB_RM  = 0;
	MSB_TYPE  = 0;
