...
module fft (
	...
	asj_fft_si_de_so_b_fft_90	asj_fft_si_de_so_b_fft_90_inst(
		.clk(clk),
		.reset_n(reset_n),
		.inverse(inverse),
	...
	defparam
		asj_fft_si_de_so_b_fft_90_inst.nps = 8192,
		asj_fft_si_de_so_b_fft_90_inst.bfp = 1,
		asj_fft_si_de_so_b_fft_90_inst.nume = 2,
		asj_fft_si_de_so_b_fft_90_inst.mpr = 16,
		asj_fft_si_de_so_b_fft_90_inst.twr = 16,
		asj_fft_si_de_so_b_fft_90_inst.bpr = 16,
		asj_fft_si_de_so_b_fft_90_inst.bpb = 4,
		asj_fft_si_de_so_b_fft_90_inst.fpr = 4,
		asj_fft_si_de_so_b_fft_90_inst.mram = 0,
		asj_fft_si_de_so_b_fft_90_inst.m512 = 0,
		asj_fft_si_de_so_b_fft_90_inst.mult_type = 1,
		asj_fft_si_de_so_b_fft_90_inst.mult_imp = 0,
		asj_fft_si_de_so_b_fft_90_inst.srr = "AUTO_SHIFT_REGISTER_RECOGNITION=OFF",
		asj_fft_si_de_so_b_fft_90_inst.rfs1 = "fft_1n8192sin.hex",
		asj_fft_si_de_so_b_fft_90_inst.rfs2 = "fft_2n8192sin.hex",
		asj_fft_si_de_so_b_fft_90_inst.rfs3 = "fft_3n8192sin.hex",
		asj_fft_si_de_so_b_fft_90_inst.rfc1 = "fft_1n8192cos.hex",
		asj_fft_si_de_so_b_fft_90_inst.rfc2 = "fft_2n8192cos.hex",
		asj_fft_si_de_so_b_fft_90_inst.rfc3 = "fft_3n8192cos.hex";
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_si_de_so_b_fft_90" >
...
// Retrieval info:      <PRIVATE name = "NUM_LE" value="6273"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_M4K" value="56"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_BLK_THROUGHPUT_CYCLES" value="22656"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_MEMBITS" value="458752"  type="INTEGER"  enable="1" />
